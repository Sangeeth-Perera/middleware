...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <!--h3 class="box-title"> Institute Registration</h3-->
            ...
            <!-- /.box-header -->
            <h3>No of new patient Discharges : @if(!empty($msgs)) <?=count($msgs)?>@endif</h3> 
              <section class="content">
           ...
           @if($errors->first()=="Server Not Accepting")
            ...
            <div class="box-body">
              <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                ...
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 116px;">admission date</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 80px;">discharge date</th>
                ...
                @if(!empty($msgs))
                 ...
                 <tr>
                  ...
                  <td><?= $msg->dischargeDate ?></td>

                  <td>
<a href='/{{$msg->id}}/generateA03'><input type="Button" value="Generate" action=></a>                  </td>
