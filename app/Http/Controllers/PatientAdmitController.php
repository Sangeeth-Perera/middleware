...
public function count()
    {
        ...
        return view('patientAdmit', compact('msgs'));
    }


public function generateA01($id)
    {
...
$filename=$date.'logs';
  $myfile = file_put_contents('msgs/A01'.$date.'logs.txt', $msgs1.PHP_EOL , FILE_APPEND | LOCK_EX);
 $url = "http://localhost/client/tcpA01.php?message={$id}&filename={$filename}";
...
//testing status wethor message ecived or not
        ...
        {
            return redirect('/patient/admit')->withErrors(['Server Not Accepting', 'Server Not Accepting']);
        }
      ...
      $pt->save();
        ...
        return redirect('/patient/admit')->withErrors(['Successfully sent', 'Server Not Accepting']);
    }
}
